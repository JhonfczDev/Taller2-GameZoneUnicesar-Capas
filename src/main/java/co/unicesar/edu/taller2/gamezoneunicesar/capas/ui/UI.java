...
public class UI {
    ...
    do {
        ...
        try {
            ...
            switch (option) {
                case 1 -> registerPercentageDiscountUI();
                case 2 -> registerCategoryDiscountUI();
                case 3 -> registerBulkPurchaseDiscountUI();
                case 4 -> listAllPromotionsUI();
                case 5 -> listActivePromotionsUI();
