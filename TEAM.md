...
* **Developer 2 (5 Classes):**
  ...
  2. `Customer` (Derived class for customers)
  3. `Seller` (Derived class for sellers)
...
- [ ] Implement the `Customer` derived class with specific attributes.
- [ ] Implement the `Seller` derived class with specific attributes.
